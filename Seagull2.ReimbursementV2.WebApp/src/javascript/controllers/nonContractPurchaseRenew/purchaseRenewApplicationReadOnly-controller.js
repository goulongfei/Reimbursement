define([
    ...
    app.controller('purchaseRenewApplicationReadOnly_controller', [
        '$scope', 'viewData', 'sogModal', '$window', 'configure','$http','seagull2Url',
        function ($scope, viewData, sogModal, $window, configure, $http, seagull2Url) {

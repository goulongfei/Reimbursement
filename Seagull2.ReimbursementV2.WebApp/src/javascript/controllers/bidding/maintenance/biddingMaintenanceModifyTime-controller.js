define(
    ...
    function (app) {
        app.controller('biddingMaintenanceModifyTime_controller', [
            ...
            function ($scope, $rootScope, $http, $state, $stateParams, uploader, wfOperate, viewData, $timeout, wfWaiting, sogModal, sogWfControlOperationType, seagull2Url, ValidateHelper, sogValidator, sogOguType, $filter, errorDialog, configure, $window) {
                ...
                var dateArrangeScene = viewData.sceneId == "Draft" ? "ModifyTime" : "ReadOnly";
                ...
                $scope.baseInfo = {
                    ...
                    isShowUpstreamProcessMaintenance: false
                };
                ...
                //查看开标页面
                $scope.lookbiddingMaintenanceInfo = function () {
                    var urlat = null;
                    $http.get(seagull2Url.getPlatformUrl("/PublicApi/TicketStr?r=" + new Date().getTime()))
                        .success(function (data) {
                            ...
                            if (urlat !== null) {
                                ...
                                url = $scope.common.webUrlBase + "/THRWebApp/ReimbursementV2/default.htm#/biddingMaintenanceStart/?resourceID=" + $scope.viewModel.p_PurchaseDataArrangeAdjustRecord.purchaseResourceID;
                    ...
                    if ($scope.viewModel.purchaseDateArrangeInfoList.length) {
                        angular.forEach($scope.viewModel.purchaseDateArrangeInfoList, function (v, i) {
                            if (v.classActiveName == '最新时间安排') {
                                ...
                                if (v.evaluateBiddingDeadline < v.replyDeadline) {

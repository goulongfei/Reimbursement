define(
    ...
    function (app) {
        app.controller('biddingImplementInvite_controller', [
            '$scope', 'viewData', 
                ...
                $scope.baseInfo = {
                    ...
                    linkManBankAccountChange: function (newVal, oldVal) {
                        if (newVal && newVal.affiliatedBankName !== undefined) {
                            $scope.viewModel.purchaseOfImplement.linkManBankName = newVal.affiliatedBankName;
                        }
                        else if (oldVal && !newVal) {
                            $scope.viewModel.purchaseOfImplement.linkManBankName = null;
                        }
                    },
                };

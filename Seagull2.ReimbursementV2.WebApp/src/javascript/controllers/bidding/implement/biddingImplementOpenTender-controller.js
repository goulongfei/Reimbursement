define(
    ...
    function (app) {
        app.controller('biddingImplementOpenTender_controller', [
            '$scope', 'viewData',
            ...
            function ($scope, viewData,
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingImplementOpenTender",
                ...
                $scope.api = {
                    ...
                    urlExtensionInviteReplyTime: function (param) {
                        return seagull2Url.getPlatformUrl('/BiddingImplement/ExtensionReplyTime?r=' + Math.random());
                    },
                    urlAdjustBiddingDataArrange: function (param) {
                        return seagull2Url.getPlatformUrl('/BiddingImplement/AdjustBiddingDataArrange?r=' + Math.random());
                    },
                    // 延长提问截止时间
                ...
                $scope.baseInfo = {
                    ...
                    confirmReplyDeadline: function () {
                        ...
                        var param = {
                            resourceId: $scope.resourceId,
                            replyTime: $scope.viewModel.purchaseOfImplement.lastReplyDeadline,
                        }
                    ...
                    modifyAdjustBiddingDataArrange: function () {
                        ...
                        $scope.api.adjustBiddingDataArrange(param, function (data) {
                            $scope.viewModel.purchaseOfImplement.isAdjustBiddingDataArrange = true;
                            wfWaiting.hide();
                            //需要下面的几个参数
                            var t_link = "default.htm?processDescKey=ReimbursementV2_ModifyPurchaseTime&parentResourceID=" + $scope.viewModel.resourceID + "&purchaseActivityID=" + viewData.currentActivityId + "&urlPart=biddingImplementOpenTender" + "#/modifyPurchaseTime/";
                ...
                $scope.$watch('viewModel.purchaseOfImplement.linkManBankAccountObject', $scope.baseInfo.linkManBankAccountChange, true);
                // 刷新流程
                $scope.refreshProcess = function () {
                    ...
                    if (param) {
                        wfOperate.refreshProcess('/BiddingImplementOpenTenderWf', $scope.currentActivityId, null, param, true);
                    }
                };

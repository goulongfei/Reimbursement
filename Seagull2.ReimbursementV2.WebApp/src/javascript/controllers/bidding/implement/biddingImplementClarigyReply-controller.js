define(
    ...
    function(app) {
        app.controller('biddingImplementClarigyReply_controller', [
            ...
            function($scope, viewData, $http, seagull2Url,
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingImplementClarigyReply",
                ...
                $scope.api = {
                    ...
                    urlAbandonClarifyReply: function(param) {
                        return seagull2Url.getPlatformUrl('/BiddingImplement/AbandonClarifyReply?r=' + Math.random());
                    },
                    // 延长提问截止时间

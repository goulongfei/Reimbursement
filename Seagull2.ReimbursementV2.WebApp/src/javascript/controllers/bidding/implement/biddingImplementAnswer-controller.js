define(
    ...
    function (app) {
        app.controller('biddingImplementAnswer_controller', [
            ...
            function ($scope, viewData, $rootScope, $http,
                ...
                $scope.api = {
                    ...
                    urlExtensionQuestionTime: function (param) {
                        return seagull2Url.getPlatformUrl('/BiddingImplement/ExtensionQuestionTime?r=' + Math.random());
                    },
                    // 延长提问截止时间

define(
    ...
    function (app) {
        app.controller('biddingImplementIssueBiddingDocument_controller', [
            '$scope', 'viewData',
            ...
            function ($scope, viewData,
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingImplementIssueBiddingDocument",
                ...
                $scope.api = {
                    ...
                    urlExtensionInviteReplyTime: function (param) {
                        return seagull2Url.getPlatformUrl('/BiddingImplement/ExtensionInviteReplyTime?r=' + Math.random());
                    },
                ...
                $scope.baseInfo = {
                    ...
                    // 延长邀请回复截止时间
                    confirmInviteReplyDeadline: function () {
                        wfWaiting.show();
                        var param = {
                            resourceId: $scope.resourceId,
                            inviteReplyTime: $scope.viewModel.inviteReplyDeadline,
                        }
                        $scope.api.extensionInviteReplyTime(param, function (data) {
                            angular.forEach($scope.viewModel.purchaseDateArrangeInfoList, function (item) {
                                item.inviteReplyDeadline = data.deadline;
                                wfWaiting.hide();
                                sogModal.openAlertDialog('提示', "邀请回复截止时间修改成功！");
                            });
                        });
                    },
                    // 废标
                    ...
                    modifyAdjustBiddingDataArrange: function () {
                        ...
                        $scope.api.adjustBiddingDataArrange(param, function (data) {
                            ...
                            wfWaiting.hide();
                            //需要下面的几个参数
                            var t_link = "default.htm?processDescKey=ReimbursementV2_ModifyPurchaseTime&parentResourceID=" + $scope.viewModel.resourceID + "&purchaseActivityID=" + viewData.currentActivityId + "&urlPart=biddingImplementIssueBiddingDocument" + "#/modifyPurchaseTime/";

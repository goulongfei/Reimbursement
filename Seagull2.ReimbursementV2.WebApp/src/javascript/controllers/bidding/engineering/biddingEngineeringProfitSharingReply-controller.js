define(
    ...
    function (app) {
        app.controller('biddingEngineeringProfitSharingReply_controller', [
            ...
            function ($scope, viewData, $http, seagull2Url,
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingEngineeringProfitSharingReply",
                ...
                $scope.api = {
                    ...
                    urlAbandonProfitSharingReply: function (param) {
                        return seagull2Url.getPlatformUrl('/BiddingEngineering/abandonProfitSharingReply?r=' + Math.random());
                    },
                    // 延长提问截止时间

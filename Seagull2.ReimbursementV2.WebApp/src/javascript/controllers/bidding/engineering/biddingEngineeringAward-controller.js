define(
    ...
    function (app) {
        app.controller('biddingEngineeringAward_controller', [
            '$scope', 'viewData',
            ...
            function ($scope, viewData,
                ...
                $scope.settings = {
                    ...
                    contractAgreementOpts: {
                        ...
                        beforDelete: function () {
                            ...
                            angular.forEach($scope.viewModel.contractAgreementScopeList, function (agreement) {
                                $scope.viewModel.purchaseOfEngineering.purchaseCostTargetAmount += agreement.validStatus ? agreement.costTargetAmount : 0;
                            });
                        },
                    },
                    // 采购时间安排信息
                    ...
                    bidSectionInfoOpts: {
                        ...
                        afterCostTargetEdit: function (v) {
                            $scope.viewModel.purchaseOfEngineering.purchaseCostTargetAmount = v;
                        },
                ...
                $scope.baseInfo = {
                    ...
                    setIsGrantWinBiddingNotice: function (val) {
                        $scope.viewModel.purchaseOfEngineering.isGrantWinBiddingNotice = val;
                ...
                var validData = function () {
                    ...
                    var modelStateDictionary = ValidateHelper.validateData($scope.viewModel, [
                        ...
                        { key: '定标专项单方', attributeName: 'purchaseOfEngineering.calibrationSpecialPrice', validator: new RequiredValidator('不能为空！') },
                        { key: '建筑面积', attributeName: 'purchaseOfEngineering.buildingArea', validator: new RequiredValidator('不能为空！') },
                        { key: '建设单方成本目标', attributeName: 'purchaseOfEngineering.buildingCostTargetPerArea', validator: new RequiredValidator('不能为空！') },
                        { key: '是否发放中标通知', attributeName: 'purchaseOfEngineering.isGrantWinBiddingNotice', validator: new RequiredValidator('请选择！') }
                    ]);
                    // 直接委托说明
                ...
                $scope.refreshProcess = function () {
                    //改成传页面对象
                    wfOperate.refreshProcess('/BiddingEngineeringAwardWf', $scope.currentActivityId, null, $scope.viewModel, true);
                };

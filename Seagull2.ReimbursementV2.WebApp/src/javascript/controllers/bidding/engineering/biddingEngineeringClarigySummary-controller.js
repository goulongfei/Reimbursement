define(
    ...
    function (app) {
        app.controller('biddingEngineeringClarigySummary_controller', [
            '$scope', 'viewData',
            ...
            function ($scope, viewData,
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingEngineeringClarigySummary",
                ...
                var validData = function () {
                    ...
                    var modelStateDictionary = ValidateHelper.validateData($scope.viewModel, [
                        ...
                        { key: '是否发放澄清问卷', attributeName: 'purchaseOfEngineering.isGrantClarifyQuestionnaire', validator: new RequiredValidator('不能为空！') }
                    ]);
                    // 需发放标段 
                    if ($scope.viewModel.purchaseOfEngineering.isGrantClarifyQuestionnaire) {
                        if (!$scope.viewModel.purchaseOfEngineering.clarifyDeadline) {
                ...
                $scope.refreshProcess = function () {
                    var param = {
                        IsGrantClarifyQuestionnaire: $scope.viewModel.purchaseOfEngineering.isGrantClarifyQuestionnaire,
                    };
                    if (param) {
                        wfOperate.refreshProcess('/BiddingEngineeringClarigySummaryWf', $scope.currentActivityId, null, param, true);
                    }
                };

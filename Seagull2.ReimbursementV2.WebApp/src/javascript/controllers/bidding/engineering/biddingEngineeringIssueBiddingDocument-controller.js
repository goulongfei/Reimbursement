define(
    ...
    function (app) {
        app.controller('biddingEngineeringIssueBiddingDocument_controller', [
            '$scope', 'viewData',
            ...
            function ($scope, viewData,
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingEngineeringIssueBiddingDocument",
                ...
                $scope.api = {
                    ...
                    urlExtensionInviteReplyTime: function (param) {
                        return seagull2Url.getPlatformUrl('/BiddingEngineering/ExtensionInviteReplyTime?r=' + Math.random());
                    },
                ...
                $scope.baseInfo = {
                    ...
                    modifyAdjustBiddingDataArrange: function () {
                        ...
                        $scope.api.adjustBiddingDataArrange(param, function (data) {
                            ...
                            wfWaiting.hide();
                            //需要下面的几个参数
                            var t_link = "default.htm?processDescKey=ReimbursementV2_ModifyPurchaseTime&parentResourceID=" + $scope.viewModel.resourceID + "&purchaseActivityID=" + viewData.currentActivityId + "&urlPart=biddingEngineeringIssueBiddingDocument" + "#/modifyPurchaseTime/";
                ...
                $scope.refreshProcess = function () {
                    ...
                    if (param) {
                        wfOperate.refreshProcess('/BiddingEngineeringIssueBiddingDocumentWf', $scope.currentActivityId, null, param, true);
                    }
                };

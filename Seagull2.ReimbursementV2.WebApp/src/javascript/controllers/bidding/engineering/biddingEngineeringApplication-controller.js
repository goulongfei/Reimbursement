define(
    ...
    function (app) {
        app.controller('biddingEngineeringApplication_controller', [
            ...
            function ($scope, viewData, $rootScope, $http,
                ...
                //初始化期区集合-上游发起
                if ($scope.viewModel.purchaseOfEngineering.stageAreaCode) {
                ...
                $scope.settings = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: "BiddingEngineeringApplication",
                ...
                $scope.baseInfo = {
                    ...
                    setIsNeedPaymentDeposit: function (value) {
                        $scope.viewModel.purchaseOfEngineering.isNeedPaymentDeposit = value;
                    },
                    // 设置是否示范区采购
                    ...
                    contractAgreementTypeChange: function () {
                        ...
                        $scope.settings.bidSectionInfoOpts.contractAgreementTypeCode = $scope.viewModel.purchaseOfEngineering.contractAgreementTypeCode;
                ...
                var validData = function () {
                    ...
                    var modelStateDictionary = ValidateHelper.validateData($scope.viewModel, [
                        ...
                        { key: '是否需要缴纳保证金', attributeName: 'purchaseOfEngineering.isNeedPaymentDeposit', validator: new RequiredValidator('不能为空！') },
                        ...
                        { key: '本次招标范围和内容', attributeName: 'purchaseOfEngineering.purchaseContent', validator: new RequiredValidator('不能为空！') },
                        { key: '本次招标范围和内容', attributeName: 'purchaseOfEngineering.purchaseContent', validator: new stringMaxLengthValidator(4000, "不能大于4000个字符！") },
                        { key: '付款方式', attributeName: 'purchaseOfEngineering.paymentWayDescribe', validator: new RequiredValidator('不能为空！') },
                        { key: '付款方式', attributeName: 'purchaseOfEngineering.paymentWayDescribe', validator: new stringMaxLengthValidator(4000, "不能大于4000个字符!") },
                        { key: '采购负责人', attributeName: 'purchaseOfEngineering.purchaseMainUser', validator: new RequiredSelectValidator('请选择！') },
                        { key: '商务负责人', attributeName: 'purchaseOfEngineering.businessMainUser', validator: new RequiredSelectValidator('请选择！') },
                        { key: '技术负责人', attributeName: 'purchaseOfEngineering.technologyMainUser', validator: new RequiredSelectValidator('请选择！') }
                    ...
                    //  各供应商应缴纳保证金金额
                    if ($scope.viewModel.purchaseOfEngineering.isNeedPaymentDeposit === true
                        && !$scope.viewModel.purchaseOfEngineering.needPaymentDepositAmount) {
                ...
                $scope.refreshProcess = function () {
                    var param = {
                        ...
                        PurchaseCostTargetAmount: $scope.viewModel.purchaseOfEngineering.purchaseCostTargetAmount,
                    ...
                    if (!$scope.viewModel.purchaseOfEngineering.contractAgreementTypeCode) {
                        $scope.viewModel.purchaseOfEngineering.contractAgreementTypeCode = 0;
                    }
                ...
                $scope.sendPefreshRequest = function (param) {
                    ...
                    if ($scope.baseInfo.refreshing === true) {
                        ...
                        wfOperate.refreshProcess('/BiddingEngineeringApplicationWf', $scope.currentActivityId, null, param, true);
                    }
                }

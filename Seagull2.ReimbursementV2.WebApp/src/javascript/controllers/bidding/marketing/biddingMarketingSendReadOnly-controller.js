define(
    ...
    function (app) {
        app.controller('biddingMarketingSendReadOnly_controller', [
                ...
                var checkData = function () {
                    ...
                    if ($scope.viewModel.supplierScopeList.length) {
                        angular.forEach($scope.viewModel.supplierScopeList, function (v, i) {
                            ...
                            if (!v.linkPhone) error.addModelError("联系人电话", key + "联系人电话不能为空");
                            if (!v.linkEmail) error.addModelError("联系人邮箱", key + "联系人邮箱不能为空");

                            if (regPhoneNumber.test(v.linkManPhone) === false) {
                                error.addModelError('联系人电话', key + '联系人电话格式不正确');
                            }

                            if (regEmail.test(v.linkManEmail) === false) {

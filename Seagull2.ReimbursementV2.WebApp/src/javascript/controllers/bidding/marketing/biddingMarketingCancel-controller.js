define(
    ...
    function (app) {
        app.controller('biddingMarketingCancel_controller', [
            ...
            function ($scope, $rootScope, $http, $state, $stateParams, uploader, wfOperate, viewData, $timeout, wfWaiting, sogModal, sogWfControlOperationType, seagull2Url, ValidateHelper, sogValidator, sogOguType, $filter, errorDialog, configure, $window, $injector) {
                ...
                $scope.wfOperateOpts.allowRejection = viewData.sceneId == "CancelApproval" ? true : false;//退回
                $scope.wfOperateOpts.allowDoAbort = false;//作废 
                $scope.wfOperateOpts.allowDoWithdraw = viewData.sceneId == "CancelApprovalReadOnly" ? true : false;//撤回

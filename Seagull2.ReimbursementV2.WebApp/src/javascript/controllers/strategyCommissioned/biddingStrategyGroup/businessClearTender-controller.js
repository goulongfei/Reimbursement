define([
    ...
    'commonUtilExtend'], function (app) {
        app.controller('businessClearTender_controller',
            function ($scope, sogModal, viewData, sogWfControlOperationType, sogValidator, ValidateHelper, rcTools) {
                ...
                $scope.viewModel.isBusinessClearTender = true;
                //基本信息
                $scope.baseInfo = {
                    //采购信息是否显示招标附件
                ...
                var validData = function () {
                    ...
                    if ($scope.viewModel.businessFileList.length == 0 || $scope.viewModel.businessFileList[0].clientFileInformationList == null || $scope.viewModel.businessFileList[0].clientFileInformationList.length == 0) {

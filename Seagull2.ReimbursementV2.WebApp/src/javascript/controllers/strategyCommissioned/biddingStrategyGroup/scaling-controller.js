define(['app', 'commonUtilExtend', 'leftNavExtend', 'enterpriseShowExtend', 'biddingSynthesizeExtend'], function (app) {
    app.controller('scaling_controller',
        function ($scope, $http, wfOperate, seagull2Url, wfWaiting, sogModal, viewData, sogWfControlOperationType, sogOguType, sogValidator, ValidateHelper, configure, $window) {

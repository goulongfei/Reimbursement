define([
    ...
    'commonUtilExtend'], function (app) {
        app.controller('technologyClearTender_controller',
            function ($scope, sogModal, viewData, sogWfControlOperationType, sogValidator, ValidateHelper, rcTools) {
                ...
                $scope.viewModel.isBusinessClearTender = false;
                //基本信息
                $scope.baseInfo = {
                    //采购信息是否显示招标附件
                ...
                var validData = function () {
                    ...
                    if ($scope.viewModel.technologyFileList.length == 0 || $scope.viewModel.technologyFileList[0].clientFileInformationList == null || $scope.viewModel.technologyFileList[0].clientFileInformationList.length == 0) {

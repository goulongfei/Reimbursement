define([
    'app',
    'leftNavExtend',
    'dateTimePickerExtend', 'commonUtilExtend'], function (app) {
        app.controller('openTender_controller',
            function ($injector, $scope, $rootScope, $http, $state, wfOperate, seagull2Url, wfWaiting, sogModal, $location, viewData, sogWfControlOperationType, sogOguType, sogValidator, ValidateHelper) {
                ...
                $scope.updateReplyDeadline = function () {
                    ...
                    wfWaiting.show();
                    $http.get(seagull2Url.getPlatformUrl('/BiddingStrategyGroup/CommitReplyDeadlineTime?resourceID=' + $scope.viewModel.resourceID + '&replyDeadline=' + $scope.viewModel.replyDeadline), {
                        cache: false
                ...
                $scope.editpurchaseDatearrange = function () {
                    wfWaiting.show();
                    $http.get(seagull2Url.getPlatformUrl("/BiddingStrategyGroup/AdjustBiddingDataArrange?resourceID=" +
                        ...
                        .success(function () {
                            ...
                            wfWaiting.hide();
                            var t_link = "default.htm?processDescKey=ReimbursementV2_ModifyPurchaseTime&parentResourceID=" + $scope.viewModel.resourceID + "&purchaseActivityID=" + viewData.currentActivityId + "&urlPart=biddingStrategyGroupOpenTender" + "#/modifyPurchaseTime/";

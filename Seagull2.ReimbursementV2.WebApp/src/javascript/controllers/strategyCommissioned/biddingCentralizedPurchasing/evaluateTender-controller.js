define([
    ...
    'commonUtilExtend'], function (app) {
        app.controller('evaluateTender_controller',
            function ($injector, $scope, $rootScope, $http, $state, wfOperate, seagull2Url, wfWaiting, sogModal, $location, viewData, sogWfControlOperationType, sogOguType, sogValidator, ValidateHelper, rcTools) {
                ...
                $scope.baseInfo = {
                    ...
                    leftNavListOpts: {
                        ...
                        scene: $scope.viewModel.isBusinessEvaluateTender ? "BusinessEvaluteTender" : "TechnologyEvaluteTender",
                ...
                var validData = function () {
                    ...
                    if ($scope.viewModel.isBusinessEvaluateTender) {
                        if ($scope.viewModel.businessEvaluateTenderFileList[0].clientFileInformationList == null || $scope.viewModel.businessEvaluateTenderFileList[0].clientFileInformationList.length == 0) {
                        ...
                        if ($scope.viewModel.technologyEvaluateTenderFileList[0].clientFileInformationList == null || $scope.viewModel.technologyEvaluateTenderFileList[0].clientFileInformationList.length == 0) {

        ...
        app.controller('answeringQuestion_controller',
            function ($injector, $scope, $rootScope, $http, $state, wfOperate, seagull2Url, wfWaiting, sogModal, $location, viewData, sogWfControlOperationType, sogOguType, sogValidator, ValidateHelper, rcTools) {
                ...
                $scope.commitSupplier = function () {
                    ...
                    wfWaiting.show();
                    $http.post(seagull2Url.getPlatformUrl('/BiddingCentralizedPurchasing/CommitSupplier'), $scope.viewModel.p_AnswerInfoPEMus[newest])
                ...
                $scope.commit = function () {
                    ...
                    wfWaiting.show();
                    $http.get(seagull2Url.getPlatformUrl('/BiddingCentralizedPurchasing/CommitTime?resourceID=' + $scope.viewModel.p_StrategyPurchasePlanCase.resourceID + '&extendTime=' + $scope.baseInfo.extendTime), {
                        cache: false
                        ...
                        if (data) {
                            ...
                            sogModal.openAlertDialog("提示", "提交最新提问截止时间错误");
                        }
                        wfWaiting.hide();
                    });
                };

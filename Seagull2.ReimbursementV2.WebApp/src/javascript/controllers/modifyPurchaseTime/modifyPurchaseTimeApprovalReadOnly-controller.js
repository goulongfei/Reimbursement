define(
    ...
    function (app) {
        app.controller('modifyPurchaseTimeApprovalReadOnly_controller', [
            '$scope', '$http', 'viewData', 'wfWaiting', 'seagull2Url', 'sogOguType', 'errorDialog', 'configure', '$window',
            function ($scope, $http, viewData, wfWaiting, seagull2Url, sogOguType, errorDialog, configure, $window) {
